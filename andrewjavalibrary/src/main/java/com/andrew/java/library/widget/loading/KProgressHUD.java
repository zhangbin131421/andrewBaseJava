...
package com.andrew.java.library.widget.loading;
...
import com.andrew.java.library.widget.loading.views.AnnularView;
import com.andrew.java.library.widget.loading.views.BarView;
import com.andrew.java.library.widget.loading.views.PieView;
import com.andrew.java.library.widget.loading.views.SpinProgressView;
import com.andrew.java.library.widget.loading.views.SpinView;


public class KProgressHUD {

    public enum Style {
        SPIN_INDETERMINATE, SPIN_DETERMINATE, PIE_DETERMINATE, ANNULAR_DETERMINATE, BAR_DETERMINATE
    }
    ...
    public KProgressHUD setStyle(Style style) {
        ...
        switch (style) {
            case SPIN_INDETERMINATE:
                ...
                break;
            case SPIN_DETERMINATE:
                view = new SpinProgressView(mContext);
                break;
     ...
     * @return Current HUD
     */
    public KProgressHUD setMaxProgress(long maxProgress) {
